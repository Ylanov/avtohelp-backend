...
def notify_friend_request(invited_id):
    ...
    notification = (
        base_models.PushNotification.objects.make_friend_request_notification(
            user=invited_id
        )
    )
...
def notify_chat_participants(sender_id, room_id, participants):
    ...
    for user_id in participants:
        ...
        unread_messages = (
            chat_models.ChatRoom.objects.by_room(room_id=room_id)
        ...
        notification = (
            base_models.PushNotification.objects.make_new_message_notification(
...
def notify_new_newsletter_comment(newsletter_comment_id):
    ...
    comment = base_models.NewsletterComment.objects.filter(
