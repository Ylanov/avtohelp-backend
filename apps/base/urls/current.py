...
urlpatterns = [
    ...
    path('news/<int:newsletter_id>/comments', views.NewsCommentCreateView.as_view(),
         name='news-comment-create'),
    path('comments/<int:pk>', views.NewsCommentUpdateView.as_view(),
         name='news-comment-update'),
    path('comments/<int:pk>/delete', views.NewsCommentDeleteView.as_view(),
