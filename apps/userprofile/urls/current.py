...
urlpatterns = [
    ...
    path('profile/cars/<int:pk>', views.ProfileCarDetailView.as_view(), name='profile-car-detail'),
    path('profile/cars/add', views.ProfileCarCreateView.as_view(), name='profile-car-create'),
    path('profile/cars/delete/<int:pk>', views.ProfileCarDeleteView.as_view(), name='profile-car-delete'),
