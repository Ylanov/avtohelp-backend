...
urlpatterns = [
    ...
    path(
        "profile/detail", views.MyProfileDetailView.as_view(), name="my-profile-detail"
    ),
    path(
        "profile/change_avatar",
        views.ProfileChangeAvatarView.as_view(),
        name="change-profile-avatar",
    ),
    path(
        "profile/update-location",
        views.ProfileLocationUpdateView.as_view(),
        name="update-profile-location",
    ),
    # Profile car
    path("profile/cars", views.ProfileCarListView.as_view(), name="profile-car-list"),
    path(
        "profile/cars/<int:pk>",
        views.ProfileCarDetailView.as_view(),
        name="profile-car-detail",
    ),
    path(
        "profile/cars/add",
        views.ProfileCarCreateView.as_view(),
        name="profile-car-create",
    ),
    path(
        "profile/cars/delete/<int:pk>",
        views.ProfileCarDeleteView.as_view(),
        name="profile-car-delete",
    ),
    # Profile gallery
    path(
        "profile/gallery",
        views.ProfileGalleryListView.as_view(),
        name="profile-gallery-list",
    ),
    path(
        "profile/gallery/<int:pk>",
        views.ProfileGalleryDetailView.as_view(),
        name="profile-gallery-detail",
    ),
    path(
        "profile/gallery/add",
        views.ProfileGalleryCreateView.as_view(),
        name="profile-gallery-create",
    ),
    path(
        "profile/gallery/<int:pk>/delete",
        views.ProfileGalleryDeleteView.as_view(),
        name="profile-gallery-delete",
    ),
    # Friendlist
    path(
        "profile/friends", views.ProfileFriendListView.as_view(), name="friendlist-list"
    ),
    path(
        "profile/friends/add",
    ...
    path(
        ...
        views.FriendListDestroyView.as_view(),
        name="friendlist-delete",
    ),
    path(
        "profile/friends/requests/incoming",
        views.InFriendRequestListView.as_view(),
    ...
    path(
        ...
        views.OutFriendRequestDeleteView.as_view(),
        name="my-friendrequest-delete",
    ),
    # Blacklist
    path(
        "profile/blacklist",
        views.ProfileBlackListView.as_view(),
    ...
    path(
        ...
        views.BlackListDestroyView.as_view(),
        name="blacklistrequest-delete",
    ),
    # User counter
    path("profiles/count", views.ProfileCountView.as_view(), name="profile-count"),
]
