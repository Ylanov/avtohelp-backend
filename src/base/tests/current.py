...
class TestCatalog(APITestCase):
    ...
    def test_news_list(self):
        ...
        self.assertEqual(
            ...
            models.Newsletter.objects.count(),
        )
    ...
    def test_news_detail(self):
        ...
        response = self.client.get(
            reverse(api_path, kwargs={"pk": self.news[0].id})
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_notifications_list(self):
        ...
        self.assertEqual(
            ...
            models.PushNotification.objects.count(),
        )
    ...
    def test_notification_schedule(self):
        ...
        self.assertEqual(
            response.data[0].get("minutes"), scheduled_time.minute
        )
