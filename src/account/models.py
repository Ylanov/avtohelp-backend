...
class UserQuerySet(models.QuerySet):
    ...
    def annotate_distance_from_assistance_request(self, assistance_request):
        ...
        return self.annotate_geo_position_relevance().annotate(
...
class UserManager(AbstractUserManager):
    ...
    def make(self, phone):
        ...
        Profile = apps.get_model(app_label="userprofile", model_name="Profile")
        ProfileLocation = apps.get_model(
            app_label="userprofile", model_name="ProfileLocation"
        )
    ...
    def get_or_make(self, phone):
        ...
        if qs.exists():
            ...
            if not hasattr(obj[0], "profile"):
                logger.info(
                    f"INFO: {obj[0].phone} has no Profile obj.\n"
